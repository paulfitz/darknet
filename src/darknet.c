...
extern void run_segmentor(char *datacfg, char *cfgfile, char *weightfile, char *filename, char *output_filename, float thresh, float hier_thresh);
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        float thresh = find_float_arg(argc, argv, "-thresh", .24);
        run_segmentor(argv[2], argv[3], argv[4], argv[5], argv[6], thresh, .5);
